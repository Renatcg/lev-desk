...
const CollapsibleResizableHandle = ({
  collapsed,
  onToggleCollapse,
  className,
  ...props
  ...
  >
    <button
      ...
      className="z-10 flex h-8 w-5 items-center justify-center rounded-sm border bg-border hover:bg-accent transition-colors"
...
export { ResizablePanelGroup, ResizablePanel, ResizableHandle, CollapsibleResizableHandle };
